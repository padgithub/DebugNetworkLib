...
class DNLDetailsController: DNLGenericController {
    ...
    func getInfoStringFromObject(_ object: DNLHTTPModel) -> NSAttributedString
    {
    ...
    func getRequestStringFromObject(_ object: DNLHTTPModel) -> NSAttributedString
    {
        var tempString: String
        tempString = String()
    ...
    func getRequestBodyStringFooter(_ object: DNLHTTPModel) -> String {
        var tempString = "\n-- Body --\n\n"
    ...
    func getResponseStringFromObject(_ object: DNLHTTPModel) -> NSAttributedString
    {
        if (object.noResponse) {
    ...
    func getResponseBodyStringFooter(_ object: DNLHTTPModel) -> String {
        var tempString = "\n-- Body --\n\n"
